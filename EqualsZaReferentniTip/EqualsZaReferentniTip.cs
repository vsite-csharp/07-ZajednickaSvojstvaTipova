...
namespace Vsite.CSharp.ZajedničkaSvojstvaTipova
{
    ...
    public class Osoba : IEquatable<Osoba>
    {
        ...
        public bool Equals(Osoba other)
        {
            ...
            // ili matičniBroj == other.matičniBroj
        }

        // override Equals tab tab
    ...
    class EqualsZaReferentniTip
    {
        public static void UsporedbaOsoba(Osoba osobaA, Osoba osobaB)
        {
            ...
            Console.WriteLine(Osoba.Equals(osobaA, osobaB)); //vraća false jer je null referenca sa staitčkim vraća false
