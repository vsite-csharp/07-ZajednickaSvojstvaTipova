...
namespace Vsite.CSharp.ZajedničkaSvojstvaTipova
{
    ...
    class MetodaEquals
    {
        public static void UsporedbaKlasa()
        {
            ...
            Console.WriteLine(Equals(mk1, mk2)); // poziva virtualnu metodu Equals od tog tipa

            // :021 Usporediti reference na objekte mk1 i mk2 korištenjem statičke metode MojaKlasa.ReferenceEquals te ispisati rezultat
            Console.WriteLine(ReferenceEquals(mk1, mk2)); //uvijek usporeduje po adresama

            // :022 Usporediti objekte mk1 i mk2 pozivom metode mk1.Equals te ispisati rezultat
            Console.WriteLine(mk1.Equals(mk2)); //bit ce pozvana equals od mk1 (iz objecta), a ona radi usporedbu po referencama

            // :023 Usporediti objekte mk1 i mk2 pozivom metode mk2.Equals te ispisati rezultat
            //Console.WriteLine(mk2?.Equals(mk1)); //NullReferenceException jer pokrecemo metodu na objektu koji ne postoji
            // zato je bolje koristiti staticku metodu Equals (ona iz 020)
        ...
        public static void UsporedbaStruktura()
        {
            ...
            MojaStruktura ms2 = new MojaStruktura(); //struktura ne moze biit null reference
