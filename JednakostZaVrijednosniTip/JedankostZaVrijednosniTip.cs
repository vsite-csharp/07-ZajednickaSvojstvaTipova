...
namespace Vsite.CSharp.ZajedničkaSvojstvaTipova
{
    ...
    public class JednakostZaVrijedniTip
    {
        public static void Jednakost(Osoba osobaA, Osoba osobaB)
        {
            ...
            // Odg: Ne moze se prevesti i izvesti -> == i != operatori ne mogu bit pozvani nad objektima tipa EqualsZaVrijednosniTip.Osoba
            Console.WriteLine($"{osobaA} == {osobaB}: {osobaA == osobaB}");
            Console.WriteLine($"{osobaA} != {osobaB}: {osobaA != osobaB}");

            // 071 Strukturi Osoba u projektu MetodaEqualsZaVrijednosniTip definirati operatore == i != tako da donji primjeri daju očekivane rezultate.
        }
