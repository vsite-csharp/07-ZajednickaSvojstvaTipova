...
namespace Vsite.CSharp.ZajedničkaSvojstvaTipova
{
    ...
    class SystemObject
    {
        public static void IspisToString()
        {
            ...
            //Metoda tostring ispisuje puno ime objekta .
            //Imamo ovdje 2 objekta
        }
        ...
        public static void IspisGetHashCode()
        {
            ...
            Console.WriteLine(mk3.GetHashCode()); // podatak nije identičan od run-a do run-a
            //podatak koji se koristi samo tijekom izvođenja programa
            // dva različita koda, jedan objekt  je identičan, jednoznačno označen objekt
        }
