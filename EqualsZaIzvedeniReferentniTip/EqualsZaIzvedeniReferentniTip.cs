...
namespace Vsite.CSharp.ZajedničkaSvojstvaTipova
{
    ...
    class Student : Osoba, IEquatable<Student> // moramo implementirati Equals() metodu, Ctrl + . -> implement interface
    {
        ...
        {
            if (base.Equals(other) == false) // ako provjera u baznom tipu nije prošla onda objekti sigurno nisu jednaki
                return false;
            if (ReferenceEquals(this, other)) // ponovno optimizacija kao u zadnjem primjeru
                return true;
